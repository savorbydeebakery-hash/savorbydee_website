/**
 * MagicUI "magic-card", vendored from https://magicui.design/r/magic-card.json
 *
...
export function MagicCard(props: MagicCardProps) {
  ...
  // Site is single-theme (light), so the theme branch collapses to a constant
  // and next-themes is not needed.
